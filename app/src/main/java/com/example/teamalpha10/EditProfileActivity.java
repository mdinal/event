...
public class EditProfileActivity extends AppCompatActivity {
    ...
    TextView save,tv_change,tv_remove;
    MaterialEditText fullname,username,bio;
    FirebaseUser firebaseUser;
    private Uri mImageUri;
    private StorageTask uploadTastk;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_change=findViewById(R.id.tv_chage);
    ...
    private void uploadImage(){
        ...
        if(mImageUri !=null){
            ...
            uploadTastk=filereference.putFile(mImageUri);
            uploadTastk.continueWithTask(new Continuation() {
                @Override
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode==CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE && resultCode==RESULT_OK){
            ...
            Toast.makeText(this,"Something gone wronge",Toast.LENGTH_SHORT).show();
        }
    }
}
